...
workflow VUMCStarFusionAndCountSnapShot {
  input {
    String sample_name
    ...
    String reference_snapshot_fusion_path = "/mnt/disks/star_fusion"
    String reference_snapshot_star_path = "/mnt/disks/star_fusion/ref_genome.fa.star.idx"
  ...
  call RNAseqUtils.STARForCount_SnapShot as STAR_Unsorted {
    input:
      ...
      reference_snapshot_path = reference_snapshot_star_path,
  ...
  call RNAseqUtils.star_fusion_SnapShot as STARFusion {
    input:
      sample_name = sample_name,
