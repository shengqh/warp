...
import "../../../../../../tasks/vumc_biostatistics/VUMCUnmappedCramToAlignedBam.wdl" as ToBam

# WORKFLOW DEFINITION
workflow WholeGenomeGermlineSingleSampleFromCram {
  ...
  call ToBam.VUMCUnmappedCramToAlignedBam as UnmappedBamToAlignedBam {
    input:
